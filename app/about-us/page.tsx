...
export default function AboutUsPage() {
  return (
    <main className="flex-1 px-4 py-8 md:py-12 lg:py-16">
      <div className="mx-auto max-w-5xl flex flex-col gap-12 md:gap-16 lg:gap-20">
        {/* Hero Section */}
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-white/90 text-base font-normal leading-normal max-w-2xl mx-auto md:text-lg">
                  Bringing transparency and honesty to your shopping decisions.
                </h2>
              </div>
            </div>
          </div>
        ...
        <section>
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-base md:text-lg font-normal leading-relaxed">
              Our portal was founded with a simple yet powerful goal: to create
              a space where consumers can find trustworthy, unbiased reviews for
              the products they use every day. We believe in empowering shoppers
              with the information they need to make confident purchasing
              decisions, fostering a community built on honesty and shared
              experiences.
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-4 p-6 bg-white dark:bg-background-dark/50 border border-gray-200 dark:border-white/10 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                We foster a supportive community where users can share insights
                and help others.
              </p>
            </div>
            <div className="flex flex-col gap-4 p-6 bg-white dark:bg-background-dark/50 border border-gray-200 dark:border-white/10 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Our platform is dedicated to featuring high-quality products and
                in-depth reviews.
              </p>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center gap-4 p-6 bg-white dark:bg-background-dark/50 border border-gray-200 dark:border-white/10 rounded-xl">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Jane is passion for consumer rights led her to create a platform
