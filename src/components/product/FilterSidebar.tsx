        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <button className="flex items-center gap-1 w-full text-left p-1 rounded hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50">
              ...
              <span className="text-sm ml-1">5 stars</span>
            </button>
            <button className="flex items-center gap-1 w-full text-left p-1 rounded hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50 bg-primary/20 dark:bg-primary/30">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-5 h-5 text-neutral-300 dark:text-neutral-500"
              >
                <path
                  fillRule="evenodd"
                  d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z"
