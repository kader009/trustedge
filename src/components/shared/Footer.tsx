...
const Footer = () => {
  return (
    <footer className="bg-card-dark dark:bg-card-dark text-white/80">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <form className="flex">
              <input
                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-l-lg text-text-light dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border-0 bg-white/10 dark:bg-white/5 h-10 placeholder:text-gray-400 px-4 text-sm font-normal leading-normal"
